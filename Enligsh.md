...
1.  N-count A port is a harbour area where ships load and unload goods or
    passengers.

港口

1.  A port on a computer is a place where you can attach another piece of
...
1.  v to turn or be turned towards the port
...
1.  V-t If people or animals desert a place, they leave it and it becomes empty.
...
2.  N-VAR 遗弃
    ...
    1.  V-T/V-I If you desert something that you support, use, or are involved with, you stop supporting it,using it,or being involved with it. 放弃
...
9.  These boys are classmates.

10. These girls are peers.
